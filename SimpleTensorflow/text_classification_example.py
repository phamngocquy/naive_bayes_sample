...
def main(unused_argv):
    ...
    df_target = pandas.read_csv("/home/haku/PycharmProjects/DemoOnce/data/categories_matrix.csv")
    df_lables = pandas.read_csv("/home/haku/PycharmProjects/DemoOnce/data/product_matrix.csv")

    x_train, x_test, y_train, y_test = train_test_split(df_lables, df_target, test_size=0.25, random_state=1)
